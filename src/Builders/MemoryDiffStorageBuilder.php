...
class MemoryDiffStorageBuilder {
	 ...
	 * @return self<addKey<TKeySpec, TRowKeyName, TBoolField>, TValueSpec, TExtraSpec>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<addKey<TKeySpec, TRowKeyName, TIntField>, TValueSpec, TExtraSpec>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<addKey<TKeySpec, TRowKeyName, TFloatField>, TValueSpec, TExtraSpec>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<addKey<TKeySpec, TRowKeyName, TStringField>, TValueSpec, TExtraSpec>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<addKey<TKeySpec, TRowKeyName, TMoneyField>, TValueSpec, TExtraSpec>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<addKey<TKeySpec, TRowKeyName, TMd5Field>, TValueSpec, TExtraSpec>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<TKeySpec, addKey<TValueSpec, TRowKeyName, TBoolField>, TExtraSpec>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<TKeySpec, addKey<TValueSpec, TRowKeyName, TIntField>, TExtraSpec>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<TKeySpec, addKey<TValueSpec, TRowKeyName, TFloatField>, TExtraSpec>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<TKeySpec, addKey<TValueSpec, TRowKeyName, TStringField>, TExtraSpec>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<TKeySpec, addKey<TValueSpec, TRowKeyName, TMoneyField>, TExtraSpec>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<TKeySpec, addKey<TValueSpec, TRowKeyName, TMd5Field>, TExtraSpec>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<TKeySpec, TValueSpec, addKey<TExtraSpec, TRowKeyName, TBoolField>>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<TKeySpec, TValueSpec, addKey<TExtraSpec, TRowKeyName, TIntField>>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<TKeySpec, TValueSpec, addKey<TExtraSpec, TRowKeyName, TFloatField>>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<TKeySpec, TValueSpec, addKey<TExtraSpec, TRowKeyName, TStringField>>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<TKeySpec, TValueSpec, addKey<TExtraSpec, TRowKeyName, TMoneyField>>
	 */
	 ...
	 * @template TRowKeyName of literal-string
	 * @param TRowKeyName $rowKeyName
	 * @return self<TKeySpec, TValueSpec, addKey<TExtraSpec, TRowKeyName, TMd5Field>>
	 */
