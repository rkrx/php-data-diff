...
This component is interesting for you, if you have a lot of structured data to import into a local database (for example) for example and you don't want to overwrite everything on each run. Instead, you want to know, what has changed actually and act accordingly.
